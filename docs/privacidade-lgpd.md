...
Registradores (ARISP) Matrícula: Lista de Pedidos segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [registradores_matric_lista@mcp.ai](mailto:registradores_matric_lista@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
